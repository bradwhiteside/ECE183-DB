...
class Controller_PID_Point2Point():
    def __init__(self, get_state, get_time, actuate_motors, get_estimated_state, get_L, params,  quad_identifier):
    ...
    def update(self):
        ...
        self.gammai_term += self.ANGULAR_I[2]*(dest_gamma-gamma)
